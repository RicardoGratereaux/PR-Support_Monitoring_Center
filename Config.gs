const CONFIG = {
  ...
  SUPERVISORES: ["seguridad@prsup.net", "mbrito@prsup.net", "seguridad07@prsup.net"],
  NOTIFICACIONES: {
    ALERTA_CRITICA: "seguridad09@prsup.net",
    RESUMEN_DIARIO_TO: "seguridad@prsup.net",
    RESUMEN_DIARIO_CC:
      "mrodriguez@farmaciasreypr.com, mbrito@prsup.net, rreynoso@chinatownandmore.com, yalbelo@farmaciasreypr.com"
  },
